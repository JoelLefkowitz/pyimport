...
@scenario('tests/get_resource.feature', 'A module is imported without affecting sys.path')
def test_a_module_is_imported_without_affecting_syspath():
    """A module is imported without affecting sys.path."""


@scenario('tests/get_resource.feature', 'An object is retrieved without affecting sys.path')
...
@scenario('tests/get_resource.feature', 'Cannot get an object from a module that does not exist')
